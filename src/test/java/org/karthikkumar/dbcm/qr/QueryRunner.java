...
/**
 * An Utility to execute Queries in a batch fashion against any Database. <br>
 * <br>
 * It reads queries from <b>"data/query.txt"</b>, uses ConnectionManagerHelper
 * for the default Connection. It reads queries line by line, executes them and
 * runs them against the database. Finally, errors and output are written to
 * <b>"data/output.txt"</b>.
 *
...
public class QueryRunner {
	...
	public static void main(String[] pArgs) {
		...
		if (mInputFile == null)
			mInputFile = System.getProperty(INPUTFILE, DEFINPUTFILE);
		if (mOutputFile == null)
			mOutputFile = System.getProperty(OUTPUTFILE, DEFOUTPUTFILE);
		...
		try {
			while ((mTemp = mIBR.readLine()) != null) {
				...
				if (!isEmpty(mSQLQuery) && !mSQLQuery.startsWith("#") && !mSQLQuery.startsWith("//")) {
